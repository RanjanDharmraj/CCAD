...
import com.perpule.serialcommunication.deviceids.CH34xIds;
import com.perpule.serialcommunication.deviceids.CP210xIds;
import com.perpule.serialcommunication.deviceids.FTDISioIds;
import com.perpule.serialcommunication.deviceids.PL2303Ids;
...
public abstract class UsbSerialDevice implements UsbSerialInterface {
    ...
    UsbSerialDevice(UsbDevice device, UsbDeviceConnection connection) {
        this.device = device;
    ...
    private static UsbSerialDevice createUsbSerialDevice(UsbDevice device, UsbDeviceConnection connection, int iface) {
        /*
    ...
    protected class WorkerThread extends Thread {
        ...
        WorkerThread(UsbSerialDevice usbSerialDevice) {
        ...
        public void run() {
            while (working.get()) {
                ...
                if (request != null && request.getEndpoint().getType() == UsbConstants.USB_ENDPOINT_XFER_BULK && request.getEndpoint().getDirection
    ...
    protected class ReadThread extends Thread {
        ...
        public void run() {
            ...
            while (working.get()) {
                int numberBytes;
                if (inEndpoint != null)
                    numberBytes = connection.bulkTransfer(inEndpoint, serialBuffer.getBufferCompatible(), SerialBuffer.DEFAULT_READ_BUFFER_SIZE, 0);
                else
                    numberBytes = 0;
