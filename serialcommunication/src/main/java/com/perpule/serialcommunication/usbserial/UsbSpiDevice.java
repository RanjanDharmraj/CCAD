...
import com.perpule.serialcommunication.deviceids.CP2130Ids;
...
public abstract class UsbSpiDevice implements UsbSpiInterface {
    ...
    UsbSpiDevice(UsbDevice device, UsbDeviceConnection connection) {
        this.device = device;
    ...
    private static UsbSpiDevice createUsbSerialDevice(UsbDevice device, UsbDeviceConnection connection, int iface) {
    ...
    void setThreadsParams(UsbEndpoint inEndpoint, UsbEndpoint outEndpoint) {
        if (writeThread != null)
